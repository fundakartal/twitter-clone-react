...
export const MessagesIconActive = () => {
  return (
    <Svg className='h-7 w-7'>
      <g>
...
export const BookmarksIconActive = () => {
  return (
    <Svg className='h-7 w-7'>
      <g>
...
export const DotsHorizontal = ({ className }) => {
  return (
...
export const CreateTweetIcon = ({ className }) => {
  return (
    <Svg className={className}>
      <g>
...
export const LikeIconFilled = ({ className }) => {
  return (
    <Svg className={className}>
      <g>
